...
public class FlightDAO {
	...
	public List<Route> getAllRoutes(AirlineIdMap airlineIdMap, AirportIdMap airportIdMap, RouteIdMap routeIdMap) {
		...
		try {
			...
			int counter = 0;
			while (res.next()) {
				Airport sourceAirport = airportIdMap.get(res.getInt("Sources_airport_ID"));
				...
				Route route = new Route(counter, airline, sourceAirport,destinationAirport,res.getString("Codeshare"),res.getInt("Stops"),res.getString("Equipment")); 
